...
import com.abbusteps.app.data.dao.StepRecordDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `step_records` (`date` TEXT NOT NULL, `steps` INTEGER NOT NULL, `distance` REAL NOT NULL, `calories` REAL NOT NULL, `lastUpdated` INTEGER NOT NULL, PRIMARY KEY(`date`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '129b9ec688c8a71b85377de229aa99c8')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsStepRecords.put("date", new TableInfo.Column("date", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsStepRecords.put("calories", new TableInfo.Column("calories", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsStepRecords.put("lastUpdated", new TableInfo.Column("lastUpdated", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoStepRecords.equals(_existingStepRecords)) {
          return new RoomOpenHelper.ValidationResult(false, "step_records(com.abbusteps.app.data.model.StepRecord).\n"
                  + " Expected:\n" + _infoStepRecords + "\n"
                  + " Found:\n" + _existingStepRecords);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "129b9ec688c8a71b85377de229aa99c8", "eaf76d2436d115b00d216cfe49aa34b6");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "step_records");
  }
